...
const FORM_FIELDS = {
    name: 'entry.1206393464',          // Full Name
    email: 'entry.934523586',          // Email Address  
    phone: 'entry.366573960',          // Phone Number
    projectAddress: 'entry.547291559', // Project Address
    projectDetails: 'entry.882803098', // How can we help you?
    contactMethod: 'entry.408715810',   // Preferred Contact Method
    bestTime: 'entry.1676743590'       // Best Time to Contact You
};
...
async function submitForm() {
    ...
    try {
        ...
        submitData.append(FORM_FIELDS.projectAddress, formData.projectAddress);
            ...
            <div class="grid lg:grid-cols-2 gap-20">
                ...
                <div class="space-y-12">
                    <div class="space-y-10">
                        <div class="group">
                            ...
                            <a href="mailto:info@arconstruction.com" 
                               class="text-2xl text-white hover:text-[#EDA220] transition-colors duration-300 font-light block">
                                info@arconstruction.com
                            </a>
                        </div>
                    ...
                    <div class="border-l-2 border-[#EDA220] pl-8 mt-16">
                        <p class="text-lg text-gray-300 font-light italic leading-relaxed">
                            "We believe quality construction starts with people — not just plans — and that a well-built project is the result of a well-supported relationship."
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 p-10">
                    ...
                    <div v-if="submitStatus === 'success'" 
                         class="mb-6 p-4 bg-green-600/20 border border-green-600/30 text-green-300 text-center">
                    ...
                    <div v-if="submitStatus === 'error'" 
                         class="mb-6 p-4 bg-red-600/20 border border-red-600/30 text-red-300 text-center">
                        <div class="flex items-center justify-center space-x-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
